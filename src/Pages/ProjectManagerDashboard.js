...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-[#f9fafb] border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto bg-[#f1f4f7] dark:bg-gray-800">
    ...
    <h1 className='text-center text-lg'>Yash Rai</h1>
      ...
      <ul className="space-y-2 font-medium">
         <li>
            <a href="#" className="flex items-center p-2 text-gray-600 rounded-lg hover:text-[#05276a] dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
         ...
         <li>
            <div  className="flex items-center p-2 text-gray-600 rounded-lg hover:text-[#05276a] dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
...
<div className="p-4 sm:ml-64">
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
         ...
         <div className="flex h-auto pb-8 p-2 rounded bg-[#f1f4f7] dark:bg-gray-800">
            <div>
            <h1 className="lg:text-2xl text-sm lg:p-4 p-2 font-semibold text-[#05276a] dark:text-gray-500">
              Projects Managed
            </h1>
            <div className='rounded-full flex justify-center w-32 h-32 ml-4 border-8 border-[#487fe6]'>
            <h1 className='text-center text-4xl font-semibold my-auto'>4</h1>
            </div>
            </div>
           <div className='flex mt-14 flex-col gap-4 h-auto w-2/3 pr-3'>
         ...
         <div className=" h-auto p-2 rounded bg-[#f1f4f7] dark:bg-gray-800">
            <h1 className="lg:text-2xl text-sm lg:p-4 p-2 font-semibold text-[#05276a] dark:text-gray-500">
              Skills
            </h1>
           <div className='grid lg:grid-cols-3 grid-cols-1 gap-4 px-2'>

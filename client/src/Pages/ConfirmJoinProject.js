...
export default function ConfirmJoinProject() {
  return (
    ...
    <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">Confirm Joining</h5>
        
        <div className="my-12 mx-2">
            <h6>Your request to join this project will be sent to the project manager for approval.</h6>
        </div>
